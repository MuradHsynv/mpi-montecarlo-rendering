...
int main(int argc, char** argv) {
    ...
    // Broadcast camera parameters from rank 0 to all other processes
    MPI_Bcast(camera_position_global.raw, 3, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(inv_view_matrix_global.raw, 16, MPI_FLOAT, 0, MPI_COMM_WORLD); 
    MPI_Bcast(&aspect_ratio_global, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
    MPI_Bcast(&tan_fov_half_global, 1, MPI_FLOAT, 0, MPI_COMM_WORLD);
